...
#define Sprint(...) (Serial.print(__VA_ARGS__), Serial.flush(), DEBUG_UART.print(__VA_ARGS__), DEBUG_UART.flush())
#define Sprintln(...) (Serial.println(__VA_ARGS__), Serial.flush(), DEBUG_UART.println(__VA_ARGS__), DEBUG_UART.flush())
#define Sprintf(...) (Serial.printf(__VA_ARGS__), Serial.flush(), DEBUG_UART.printf(__VA_ARGS__), DEBUG_UART.flush())
#elif defined(DEBUG_OVER_CDC)
#define Sprint(...) (DEBUG_UART.print(__VA_ARGS__), DEBUG_UART.flush())
#define Sprintln(...) (DEBUG_UART.println(__VA_ARGS__), DEBUG_UART.flush())
#define Sprintf(...) (DEBUG_UART.printf(__VA_ARGS__), DEBUG_UART.flush())
